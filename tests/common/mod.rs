...
// pub(crate) fn derive_ec_key_wide_reduction_p256 ( seed: &[u8] ) -> GenericArray<u8, U32> {
//     let ba = GenericArray::<u8,U48>::from_slice(seed);
...
//         *GenericArray::from_slice(&sj.to_be_byte_array()[16..48])
// }


// #[derive(Debug)]
// pub enum Error{ Error1}
